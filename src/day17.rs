...
// #[aoc(day17, part1)]
fn day17_part1(input: &'static str) -> usize {
...
// Uncomment next line when solution is ready
// #[aoc(day17, part2)]
fn day17_part2(input: &'static str) -> usize {
...
#[test] fn test_day17_part1() { assert_eq!(solve1(_SAMPLE), _ANS1); }
#[test] fn test_day17_part2() { assert_eq!(solve2(_SAMPLE), _ANS2); }
